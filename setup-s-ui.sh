...
PORT=8889 # Using a different port to avoid conflicts with x-ui
ARCH=$(uname -m)
...
# 2. Find the latest version of the panel
...
# Disable the API call to get the version by hardcoding the version we found
